...
/**
 * Consent section of the cookie policy page.
 */
export const Consent = () => {
    return (
        <Section heading="Recueil du consentement à l'utilisation des cookies">
            <Paragraph>
            ...
            <Paragraph>
                Vous pourrez à tout moment modifier vos préférences à
                l&apos;aide du bouton flottant &quot;Gestion des cookies&quot;.
            </Paragraph>
